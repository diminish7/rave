...
Gem::Specification.new do |s|
  ...
  s.executables = ["rave"]
  s.files = ["lib/commands/create.rb", "lib/commands/server.rb", "lib/commands/usage.rb", "lib/commands/war.rb", "lib/exceptions.rb", "lib/jars/appengine-api-1.0-sdk-1.2.1.jar", "lib/jars/jruby-core.jar", "lib/jars/ruby-stdlib.jar", "lib/mixins/controller.rb", "lib/mixins/data_format.rb", "lib/models/annotation.rb", "lib/models/blip.rb", "lib/models/context.rb", "lib/models/document.rb", "lib/models/event.rb", "lib/models/operation.rb", "lib/models/robot.rb", "lib/models/wave.rb", "lib/models/wavelet.rb", "lib/ops/blip_ops.rb", "lib/rave.rb", "bin/rave"]
